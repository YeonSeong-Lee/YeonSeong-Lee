...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=3200&pause=800&color=36BCF7&center=true&vCenter=true&width=720&lines=%EC%82%AC%EC%9A%A9%EC%9E%90%EC%9D%98+%EB%B6%88%ED%8E%B8%EC%9D%84+%EC%BD%94%EB%93%9C%EB%A1%9C+%ED%92%80%EB%8A%94+Software+Engineer;Frontend+%26+Full-stack+%C2%B7+%EC%95%84%EC%9D%B4%EB%94%94%EC%96%B4%EB%A5%BC+%EC%84%9C%EB%B9%84%EC%8A%A4%EB%A1%9C;42+Seoul+%C2%B7+%EB%A7%8C%EB%93%A4%EA%B3%A0+%EB%B0%B0%ED%8F%AC%ED%95%98%EA%B3%A0+%EC%9A%B4%EC%98%81%ED%95%A9%EB%8B%88%EB%8B%A4)](https://git.io/typing-svg)
...
> **사용자의 불편을 코드로 푸는 소프트웨어 엔지니어**입니다.

- 🎓 **42 Seoul** 기반으로 프론트엔드부터 백엔드, AI 응용까지 폭넓게 다룹니다.
- 🚀 아이디어를 **실제 사용자가 쓰는 서비스로 배포·운영**하는 것을 좋아합니다.
  - 📚 42서울 도서관 시스템 **집현전** — **1,000+ 사용자**가 사용하는 서비스를 8인 팀으로 운영
...
<table>
<thead>
<tr><th width="22%">Project</th><th>설명 &amp; 임팩트</th><th width="28%">Tech</th></tr>
</thead>
<tbody>
...
**[🗑️ sseuregi-king](https://github.com/YeonSeong-Lee/sseuregi-king)**
...
외국인을 위한 **쓰레기 분리배출 안내 서비스**. 카메라로 쓰레기를 스캔하면 Claude Vision이 품목을 인식하고, Kakao Local API로 **동네별 배출 규칙(봉투 색·배출 요일·장소)** 까지 안내합니다.
<br/>🌍 **4개국어 i18n** · ✅ **Vercel 배포 운영**
...
**[☂️ OpenUmbrella](https://github.com/YeonSeong-Lee/OpenUmbrella)** ⭐5

</td>
<td>

42서울 캠퍼스 **공유우산 서비스**. 우산 대여·반납과 사용자 인증을 갖춘 풀스택 웹 서비스로, 가장 많은 ⭐를 받은 프로젝트입니다.
<br/>👥 **협업 개발** · 🏫 **캠퍼스 실사용**
...
코디세이 플랫폼 **편의성 개선 크롬 확장 프로그램**. 드래그로 여러 평가 슬롯을 선택해 **일괄 평가 요청**, 목차 자동 숨김, 평가 후 자동 새로고침 등을 제공합니다.
...
**[🗓️ bluebird_workshift_viewer](https://github.com/YeonSeong-Lee/bluebird_workshift_viewer)**

</td>
<td>

사회복지시설용 **근무표 뷰어 데스크톱 앱**. 엑셀 근무표를 읽어 날짜·팀별로 보기 쉽게 시각화하고, **Google Drive 자동 동기화**를 지원합니다. (12 releases)
<br/>🖥️ **데스크톱 앱** · 📊 **Excel 연동**
...
- 🏸 **[RallyLens](https://github.com/YeonSeong-Lee/rallylens)** — 배드민턴 경기 영상 자동 분석 CLI 파이프라인. `Python` `YOLO11-pose` `ByteTrack` `TrackNetV3` `Kalman` `OpenCV` `PyTorch` + LLM 리포트
- 🧊 **[web_cube3d](https://github.com/YeonSeong-Lee/web_cube3d)** — 웹에서 동작하는 3D 큐브 시각화. `Svelte`
- 🖼️ **[tiny_render](https://github.com/YeonSeong-Lee/tiny_render)** — GPU 없이 구현한 소프트웨어 3D 렌더러. `C++17` `CMake`
- 📱 **[HufsLifeAcademy_app](https://github.com/YeonSeong-Lee/HufsLifeAcademy_app)** — 교육 커뮤니티 접속 안드로이드 앱. `Java` `Android`
- 🤖 **[RedKiKi](https://github.com/helloAlgorithms/RedKiKi)** — 매일 알고리즘 문제를 전송하는 스터디 관리 슬랙봇. `Python` `GitHub Actions`
- ✨ **[easy-prompt](https://github.com/YeonSeong-Lee/easy-prompt)** — 자주 쓰는 프롬프트를 빠르게 재사용하는 크롬 확장. `JavaScript`
